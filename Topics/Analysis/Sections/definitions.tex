...
A sequence is a function whose domain is an ordered subset of the integers (usually \(\N\)). If we let \(n \in \N\) and \(a_n \in \R\), then \(\left(a_n\right)_{n\in\N} = (a_1, a_2, a_3, \dots)\) is said to be a real sequence. Each number \(a_n\) is called a term of the sequence.
